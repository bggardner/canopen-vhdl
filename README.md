...
| 0x1800  | TPDO1 comm. parameter       | sub-indices 0x00-0x02 and 0x05-0x06, 11-bit CAN-ID only |
| 0x1801  | TPDO2 comm. parameter       | sub-indices 0x00-0x02 and 0x05-0x06, 11-bit CAN-ID only |
| 0x1802  | TPDO3 comm. parameter       | sub-indices 0x00-0x02 and 0x05-0x06, 11-bit CAN-ID only |
| 0x1803  | TPDO4 comm. parameter       | sub-indices 0x00-0x02 and 0x05-0x06, 11-bit CAN-ID only |
